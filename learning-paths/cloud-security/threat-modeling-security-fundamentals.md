...
**Пояснення:** Хоча формулювання може здаватися неточним, цей варіант найбільше відповідає захисту від tampering. Шифрування забезпечує цілісність даних і допомагає виявити, чи були дані змінені під час передачі. Якщо дані були підроблені, розшифрування не вдасться або результат буде некоректним.

Інші варіанти стосуються інших типів загроз:
- Логування дій відноситься до Non-repudiation
- Надання адміністративного доступу відноситься до Authorization

**Примітка:** Найточнішою відповіддю для tampering був би цифровий підпис або Message Authentication Code (MAC), але серед запропонованих варіантів шифрування є найближчим до захисту цілісності даних.
